...
<html lang="en">
	...
	?>
		...
		<!-- Footer -->
		<footer class="footer-distributed" style="background-color:#99FFCC" id="aboutUs">
		<center>
		...
		<!--	<div class="logo">
			...
			<br />
			<p style="font-size:20px;color:black">Your product Our market !!!</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px;color:black">Farmer's Friend <span>Rk Valley</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px;color:black">9000000000</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:FarmerFriend@gmail.com" style="color:black">FarmerFriend@gmail.com</a></p>
			</div>
		</div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:black">
				...
				Farmer's Friend is e-commerce trading platform for grains & grocerries...
			</p>
